define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'record/recharge/index',
                    add_url: 'record/recharge/add',
                    edit_url: 'record/recharge/edit',
                    del_url: 'record/recharge/del',
                    multi_url: 'record/recharge/multi',
                    table: 'record',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'amount', title: __('每日限额'), sortable: true},
                        {field: 'nick_name', title: __('别名'), sortable: true,operate: 'LIKE',},
                        {field: 'status', title: __('状态'), sortable: true},
                        {field: 'card_holder', title: __('持卡人'), sortable: true,operate: 'LIKE',},
                        {field: 'creator_name', title: __('管理员'), sortable: true,operate: 'LIKE',},
                        {field: 'created_at', title: __('充值时间'), formatter: Table.api.formatter.datetime, operate: 'RANGE', addclass: 'datetimerange', sortable: true},
