define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'record/cancel/index',
                    add_url: 'record/cancel/add',
                    edit_url: 'record/cancel/edit',
                    del_url: 'record/cancel/del',
                    multi_url: 'record/cancel/multi',
                    table: 'cancel',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'created_at', title: __('注销时间'), formatter: Table.api.formatter.datetime, operate: 'RANGE', addclass: 'datetimerange', sortable: true},
