...
class Backend extends Controller
{
    ...
    public const AIR_API_URL = 'https://api.airwallex.com/';

    public $apiClientID = 'iNsjIK-dQ5qU03Q3ZvMxIQ';

    public $apiKey = 'b629ab3508e8b5d7b094f1d1a3d37303cfb6d6b44b713f2df2a85652671a51d92ebb11cf1ddcda187ca4c7cf990b3787';
    ...
    public function _initialize()
    {
        $apiKey = ApiKey::find();
        if (!empty($apiKey)) {
            $this->apiClientID = $apiKey->api_client_id;
        ...
        //获取airToken
        $this->airToken = $this->getAirToken();
    }
    ...
    {
        $url = self::AIR_API_URL . "api/v1/authentication/login";
        $headers = array(
            "Content-Type: application/json",
            "x-client-id: " . $this->apiClientID,
